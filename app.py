...
my_url1 = 'www.google.com'
my_url2 = 'www.geeksforgeeks.org/python-programming-language-tutorial'
...
# Load the ML model
with gzip.open('ML_Model\phishing_model_rf.pkl.gz', 'rb') as file:
    detection_model = pickle.load(file)

def detector(some_url):
